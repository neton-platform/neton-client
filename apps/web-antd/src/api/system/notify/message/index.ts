...
export function updateNotifyMessageRead(ids: number[]) {
  return requestClient.put(
    '/member/notify-message/update-read',
    {},
    {
      params: { ids },
    },
...
export function updateAllNotifyMessageRead() {
  return requestClient.put('/member/notify-message/update-all-read');
}

/** 获取当前用户的最新站内信列表 */
export function getUnreadNotifyMessageList() {
  return requestClient.get<SystemNotifyMessageApi.NotifyMessage[]>(
    '/member/notify-message/get-unread-list',
  );
}

/** 获得当前用户的未读站内信数量 */
export function getUnreadNotifyMessageCount() {
  return requestClient.get<number>('/member/notify-message/get-unread-count');
}
